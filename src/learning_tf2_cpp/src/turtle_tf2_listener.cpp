...
public:
                    ...
                    turtle_spawned_(false)
  {
    ...
    tf_listerner_ = std::make_shared<tf2_ros::TransformListener>(*tf_buffer_);

    // Create a client to spawn a trutle
...
private:
  void on_timer() {
    ...
    if (turtle_spawning_service_ready_) {
      ...
      if (spawner_->service_is_ready()) {
        // Init request with turtlename and coordinates
  ...
  std::shared_ptr<tf2_ros::TransformListener> tf_listerner_{nullptr};
